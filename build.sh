...
# Update bucket
gsutil -m cp -r static/* gs://signature-builder-humanplus-v2logo
rm static/functions.zip

# Deploy functions
# TODO: deploy from a source repo?
region="--region=europe-west1"
options="--runtime=python37 --source=gs://signature-builder-humanplus-v2logo/functions.zip --memory=128MB --trigger-http"
